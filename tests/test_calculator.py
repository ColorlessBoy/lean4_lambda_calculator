...
def test_iff_refl(type_pool):
    Prop = Const("Prop")
    type_pool["Iff.intro"]= Forall(Prop, Forall( Prop, Forall(Forall(BoundVar(1), BoundVar(1)), Forall(Forall(BoundVar(1), BoundVar(3)), App(App(Const("Iff"), BoundVar(3)), BoundVar(2))))))
